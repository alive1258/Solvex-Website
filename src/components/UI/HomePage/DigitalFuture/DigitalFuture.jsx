          ...
          <div className="flex justify-center md:py-20 py-16">
            <div className="text-white-base text-center ">
              ...
              <div className="mt-5 font-medium text-[16px] w-full max-w-[430px] mx-auto ">
                {status === true ? (
                  <SlideUp className="text-white-base ">
                    <p>
                  ...
                  <SlideUp className="text-white-base ">
                    <p>
                      Let’s connect and create something groundbreaking. Join
                      forces with Solvex today.
                    </p>
                  </SlideUp>
                )}
              </div>
              {/* TODO: */}
              <SlideUp className="mt-12 flex justify-center items-center">
