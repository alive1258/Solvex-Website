...
const AskQuestion = () => {
  return (
    <motion.div
      ...
      viewport={{ once: false }}
      className=" h-fit border border-border-base rounded-lg bg-[#F4F4F5] px-4 py-6 md:w-full w-[385px]"
    >
          ...
          <div className="flex animate-[floatPulse_2s_ease-in-out_infinite] md:w-[144px] w-[116px] md:h-[144px] h-[116px] py-[48px] justify-center items-center shrink-0 rounded-full border border-white bg-[linear-gradient(85deg,_#2154FF_0%,_#5079FF_100%)]">
            ...
            >
              <g clipPath="url(#clip0_199_1018)">
                <circle cx="4.71415" cy="42.8577" r="20.1429" fill="white" />
                <circle cx="24.6432" cy="1.92787" r="22.0714" fill="white" />
              </g>
              <defs>
